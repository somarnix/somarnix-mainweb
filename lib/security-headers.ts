...
export const contentSecurityPolicy = {
  'default-src': ["'self'"],
  'script-src': ["'self'", "'unsafe-eval'", "'unsafe-inline'", 'https://accounts.google.com', 'https://www.google.com', 'https://www.gstatic.com', 'https://www.youtube.com', 'https://s.ytimg.com'],
  'script-src-elem': ["'self'", "'unsafe-eval'", "'unsafe-inline'", 'https://accounts.google.com', 'https://www.google.com', 'https://www.gstatic.com', 'https://www.youtube.com', 'https://s.ytimg.com'],
