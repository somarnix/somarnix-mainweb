...
export default function AdminTest() {
  ...
  const exportFilteredToExcel = () => {
    ...
    const tableHeader = `<tr>${headers
      .map((h, index) => {
        const centerCols = new Set([0, 1, 6, 7]);
...
<html>
  ...
  <body style="background:#ffffff;margin:16px;">
    <div style="font-family:Calibri,Arial,sans-serif;">
      <h2 style="margin:0 0 4px 0;color:#0f172a;">Payments Report</h2>
    ...
    <table border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;font-family:Calibri,Arial,sans-serif;font-size:12px;min-width:1600px;">
      <colgroup>
    ...
    a.href = url;
    a.download = `payments${monthPart}${yearPart}.xls`;
