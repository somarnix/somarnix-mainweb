...
export const STORY_PRESETS: { key: StoryPreset; label: string }[] = [
  ...
  { key: "family", label: "Family Story" },
  { key: "friendship", label: "Friendship" },
  { key: "romance", label: "Romance" },
  { key: "sad-ending", label: "Sad Ending" },
  { key: "happy-ending", label: "Happy Ending" },
  ...
  { key: "oddly-satisfying", label: "Oddly Satisfying" },
  { key: "cut-asmr", label: "Cut ASMR" },
  { key: "eat-asmr", label: "Eat ASMR" },
  { key: "cooking-asmr", label: "Cooking ASMR" },
  { key: "gummy-asmr", label: "Gummy ASMR" },
  { key: "visual-sensory-asmr", label: "Visual Sensory ASMR" },
  ...
  { key: "cinematic", label: "Cinematic Story" },
  { key: "documentary", label: "Documentary Style" },
  { key: "biography", label: "Biography" },
  { key: "historical", label: "Historical Story" },
...
export const STORY_PRESET_RULES: Record<StoryPreset, string> = {
  ...
  emotional:
    "Emotional tone. Soft lighting, meaningful moments, heartfelt beats.",
  family:
    "Family bonds. Warm, safe, supportive atmosphere.",
  friendship:
    "Friendship focus. Playful, supportive moments, shared joy.",
  romance:
    "Romantic tone. Intimate framing, gentle pace, warm light.",
  "sad-ending":
    "Bittersweet. Quiet pacing, subdued lighting, reflective tone.",
  "happy-ending":
    "Uplifting. Bright light, positive mood, satisfying closure.",
  inspirational:
  ...
  satisfying:
    "Smooth, pleasing motion. Clean textures, gentle repetition.",
  "oddly-satisfying":
    "Textures, repetition, precise motion. Calm mood.",
  "cut-asmr":
  ...
  "gummy-asmr":
    "ASMR: gummy, bouncy, squishy textures, soft elasticity.",
  "visual-sensory-asmr":
    "ASMR: macro texture focus, slow pans, soothing ambience.",
  "unreal-furniture-asmr":
  ...
  cinematic:
    "Cinematic. Dramatic lighting, wide shots, deliberate pacing.",
  documentary:
    "Documentary style. Observational, grounded, realistic framing.",
  biography:
    "Biography. Focus on key life moments, respectful tone.",
  historical:
    "Historical. Period-accurate details, classic framing.",
  mythology:
    "Mythology. Symbolic imagery, epic scale, timeless tone.",
};
