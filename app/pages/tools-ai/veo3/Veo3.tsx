...
const DEFAULT_TOOL_PRODUCT_SLUG = "toolveo3";
...
export default function Veo3({ toolSlug }: { toolSlug?: string }) {
  ...
  if (status === "blocked") {
    ...
    return (
      <div className="p-6 space-y-4">
        <h1 className="text-2xl font-semibold">Veo3 Tool</h1>
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      {licenseState.status === "ready" ? (
        <div className="rounded-xl border border-gray-200 bg-white p-4 text-sm text-gray-600">
          Access granted. Put your Veo3 tool UI here.
        </div>
      ) : (
